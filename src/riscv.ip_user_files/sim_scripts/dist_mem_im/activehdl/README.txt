...
#
# Generated by export_simulation on Fri Dec 20 19:39:53 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './dist_mem_im.sh' script.

./dist_mem_im.sh -reset_run
...
./dist_mem_im.sh -noclean_files

For more information on the script, please type './dist_mem_im.sh -help'.
